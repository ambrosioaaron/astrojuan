...
<div class="row">
    <div class="col-md-4 homeFeatured">
        ...
        <a class="btn btn-default" href="/events">View more &raquo;</a>
    </div>
    <div class="col-md-4 homeFeatured">
        <h2>Articles</h2>
        <p>
        ...
        <a class="btn btn-default" href="/articles">View more &raquo;</a>
    </div>
    <div class="col-md-4 homeFeatured">
        <h2>Store</h2>
        <p>Place store description here. Place store description here. Place store description here. </p>
        <a class="btn btn-default" href="#">Go to store</a>
    </div>
</div>